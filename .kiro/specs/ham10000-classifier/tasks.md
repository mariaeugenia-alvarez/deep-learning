...
- [ ] 2. Preprocesamiento de datos
  - [ ] 2.1 Implementar preprocesamiento de datos tabulares
  ...
  - [ ] 2.2 Implementar preprocesamiento de imágenes
  ...
  - [ ] 2.3 Implementar división de datos en train/val/test
...
- [ ] 3. Hito 1 - Modelo de clasificación tabular
  - [ ] 3.1 Construir arquitectura del modelo tabular
  ...
  - [ ] 3.3 Evaluar y visualizar resultados del modelo tabular
...
- [ ] 4. Hito 2 - Modelo CNN con transfer learning
  - [ ] 4.1 Construir arquitectura del modelo CNN
  ...
  - [ ] 4.3 Evaluar y visualizar resultados del modelo CNN
...
- [ ] 5. Hito 3 - Late fusion de predicciones
  - [ ] 5.1 Construir arquitectura del modelo late fusion
  ...
  - [ ] 5.2 Preparar datos y entrenar modelo late fusion
  ...
  - [ ] 5.3 Evaluar y visualizar resultados del modelo late fusion
...
- [ ] 6. Hito 4 - Early fusion de características
  - [ ] 6.1 Construir arquitectura del modelo early fusion
  ...
  - [ ] 6.2 Preparar datos y entrenar modelo early fusion
  ...
  - [ ] 6.3 Evaluar y visualizar resultados del modelo early fusion
    - Generar gráficas de entrenamiento
    - Evaluar modelo en conjunto de validación
    - Guardar modelo entrenado
...
- [ ] 7. Evaluación final en test set
  - [ ] 7.1 Evaluar los 4 modelos en conjunto de test
  ...
  - [ ] 7.2 Generar visualizaciones de resultados
  ...
  - [ ] 7.3 Presentar resultados en formato notebook ejecutado
